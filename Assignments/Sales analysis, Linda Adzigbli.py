...
# government taxes
#df_Data["sales_tax(15)"] = df_Data["net_revenue_per_product"] * 0.15
#df_Data["sales_tax(20)"] = df_Data["net_revenue_per_product"] * 0.2
#df_Data["sales_tax(25)"] = df_Data["net_revenue_per_product"] * 0.25

#15% government sales tax on net
df_Data["net_revenue_after_15%tax"] = df_Data["net_revenue_per_product"] * (1-0.15)

#20% government sales tax on net
df_Data["net_revenue_after_20%tax"] = df_Data["net_revenue_per_product"] * (1-0.2)

#25% government sales tax on net
df_Data["net_revenue_after_25%tax"] = df_Data["net_revenue_per_product"] * (1-0.25)
print(df_Data)